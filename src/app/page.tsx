...
function StudentHome({ onOpenTopic, onOpenReader, onOpenLibrary, onOpenTopicModal }: { onOpenTopic: () => void; onOpenReader: () => void; onOpenLibrary: () => void; onOpenTopicModal: () => void }) {
  return (
...
function Library({ onOpenReader, onOpenUpload }: { onOpenReader: () => void; onOpenUpload: () => void }) {
  return (
