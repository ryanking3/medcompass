...
export function WorkspaceHome({ courses, documents, notes, flashcards, planBlocks, exams, onCreateTopic, onOpenTopic, onOpenLibrary, onOpenAtlas, onOpenPlanner }: WorkspaceHomeProps) {
