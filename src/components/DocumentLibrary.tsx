    ...
    <div className="library-page">
      ...
      <section className="library-readiness" aria-label="Library readiness">
        ...
        <article>
          ...
          <p>{pendingCount ? "Open these sources to extract pages." : "No PDFs waiting on extraction."}</p>
        </article>
