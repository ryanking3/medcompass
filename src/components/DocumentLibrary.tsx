...
export function DocumentLibrary({ documents, onOpenDocument, onOpenUpload, onDocumentUpdated, onDocumentDeleted }: DocumentLibraryProps) {
  ...
  const deleteDocument = async () => {
    ...
    if (!response.ok) {
      setPrepareFeedback(result.error ?? "We couldn't delete that source.");
      return;
    }

    onDocumentDeleted(documentToDelete.id);
    setPrepareFeedback(result.warning ?? `${documentToDelete.title} was removed from your library.`);
            ...
            {filteredDocuments.map((document) => (
              <article key={document.id}>
                ...
                <span className="source-actions">
                  ...
                  <button className="source-delete" onClick={() => setDocumentToDelete(document)}>Delete</button>
