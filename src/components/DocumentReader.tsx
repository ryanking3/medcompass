    ...
    <div className="document-reader">
      ...
      <div className="document-reader-layout">
        ...
        <aside className="document-reader-next">
          ...
          <h2>Make this source studyable</h2>
          <p>We’ll extract its pages, keep citations attached, then use that context for questions, notes, and card drafts.</p>
          <div className="reader-step complete"><span>✓</span><div><strong>Private upload</strong><small>Complete</small></div></div>
          <div className="reader-step"><span>2</span><div><strong>Page extraction</strong><small>Next milestone</small></div></div>
